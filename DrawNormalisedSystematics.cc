...
int main()
{
  ...
  TFile *fileOut = new TFile((pathOutput+"Systematics_normalised_plots"+suffixName+".root").c_str(),"RECREATE");
  ...
  string axisLabels[] = {"jet 3 p_{T} (GeV)", "jet 3 p_{T} (GeV)", "jet 4 p_{T} (GeV)", "jet 4 p_{T} (GeV)", "H_{T} (GeV)", "H_{T} (GeV)", "top p_{T} (GeV)", "m_{t} (GeV)", "m_{t} (GeV)", "m_{t,alt} (GeV)", "m_{t,alt} (GeV)", "m_{t,aKF} - m_{t,bKF} (GeV)", "m_{t} - m_{t'} (GeV)", "m_{t} - m_{t'} (GeV)", "m_{lb} (GeV)", "m_{lb} (GeV)", "m_{t} + m_{lb} (GeV)", "m_{t} + m_{lb} (GeV)", "m_{W,aKF} - m_{W,bKF} (GeV)", "m_{T,W,aKF} - m_{T,W,bKF} (GeV)", "#Delta R(b,W)", "max #Delta R(b,light)", "min #Delta R(b,light)", "#Delta R(b,b)", "#Delta R(l,b_{h})", "#Delta R(l,b_{l})"};
  ...
  for (int iVar = 0; iVar < nVars; iVar++)
  {
    ...
    for (int iSuffix = 0; iSuffix < nSuffixes; iSuffix++)
    {
      ...
      c1->Update();
      c1->Write();
      c1->SaveAs((pathOutput+"Syst_overlay_"+varNames[iVar]+suffixes[iSuffix]+"_normalised"+suffixName+".png").c_str());
      c1->SetName((varNames[iVar]+suffixes[iSuffix]+"_overlay_norm_logY").c_str());
      c1->SetLogy(1);
      c1->Write();
      c1->SaveAs((pathOutput+"Syst_overlay_"+varNames[iVar]+suffixes[iSuffix]+"_normalised"+suffixName+"_logY.png").c_str());
      c1->SetLogy(0);
